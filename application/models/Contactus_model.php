...
class ContactUs_Model extends CI_Model
{
     ...
     * @return      object
     */
    public function displayList($where = array(), $order_by = array('id_contacts' => 'ASC'), $count = FALSE)
    {
        // SELECT
        self::_select();
        ...
        return $this->db->get('contact_us u')->result();
    }
    /*
     * SELECT
     *
     ...
     * @return      void
     */
    private function _orderby($order_by = array('id_contacts' => 'ASC'))
    {
        if ( ! empty($order_by))
        {
