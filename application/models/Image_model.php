...
class Image_Model extends CI_Model
{
     ...
     * @return      object
     */
    public function displayList($where = array(), $order_by = array('id_images' => 'ASC'), $count = FALSE)
    {
        // SELECT
        self::_select();
        ...
        return $this->db->get('images u')->result();
    }
    /*
     * SELECT
     *
     ...
     * @return      void
     */
    private function _orderby($order_by = array('id_images' => 'ASC'))
    {
        if ( ! empty($order_by))
        {
