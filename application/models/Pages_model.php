...

{
    ...
    public function displayList($where = array(), $order_by = array('id_pages' => 'ASC'), $count = FALSE)

    {
        ...
        return $this->db->get('pages u')->result();
    ...
    private function _orderby($order_by = array('id_pages' => 'ASC'))
