...
/*
|--------------------------------------------------------------------------
| User Trial Model Class
|--------------------------------------------------------------------------
|
| Handles the outlet table on the DB
|
| @category Model
| @author   Stephen Pabatao
*/

class UserTrial_Model extends CI_Model
{
    // ------------------------------------------------------------------------
    /*
     * Constructor
    ...
    public function displayList($where = array(), $order_by = array('id_trial_accounts' => 'ASC'), $count = FALSE)

    {
        ...
        return $this->db->get('accounts u')->result();
