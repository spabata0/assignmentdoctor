            ...
            <div class="navbar-collapse collapse">
                <div id="navbar-links2">
                    <ul class="navbar-nav flex-row">
                      <li class="nav-item">
                        <a class="nav-link" href="freesamples">Free Samples</a>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" id="<?=base_url();?>order-btn" href="order/">Order Now</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link"id="<?=base_url();?>signin-btn" href="members/">Sign-in</a>
                      </li>
                      </ul>
                 </div>
            </div>
