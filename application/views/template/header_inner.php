...
<head>
    ...
    <title>Assignment Doctor - Content Management System</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url();?>/dashboard">Assignment Doctor CMS</a>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?=base_url();?>users/edit/<?=$id;?>"><i class="fa fa-user fa-fw"></i> User Profile</a>
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="<?=base_url();?>customers"><i class="fa fa-edit fa-fw"></i>Orders</a>

                        </li>

                        <li>

                            <a href="<?=base_url();?>pages"><i class="fa fa-edit fa-fw"></i>Pages</a>

                        </li>

                        <li>

                            <a href="<?=base_url();?>settings"><i class="fa fa-edit fa-fw"></i>Settings</a>
                        ...
                        <li>
                            ...
                            <!-- <ul class="nav nav-second-level"> -->
                                ...
                                <!-- <li> -->
                                    ...
                                    <a href="<?=base_url();?>users"><i class="fa fa-user fa-fw"></i>User Management</a>
